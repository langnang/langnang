...
use Illuminates\Helper\Interfaces\StrInterface;
use Illuminates\Support\Stringable;
use Illuminates\ASCII\Facades\ASCII;
 ...
 */
class Str extends \Illuminates\Core\Illuminate implements Contracts\StrInterface
{
  /**
