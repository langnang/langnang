...
trait AbsolutePath
{
  ...
  public function setAbsolutePath($name, $value) {}
  public function getAbsolutePath($name = null)
  {
    return empty($name) && isset($this->absolutePaths[$name]) ? $this->absolutePaths : $this->absolutePaths[$name];
  }
  ...
  public function setRelativePath($name, $value) {}
  public function getRelativePath($name = null)
  {
    return empty($name) && isset($this->relativePaths[$name]) ? $this->relativePaths : $this->relativePaths[$name];
  }
  public $appPath;
  public $basePath;
  public $databasePath;
