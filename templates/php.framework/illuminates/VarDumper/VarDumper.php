...
namespace Illuminates\VarDumper;

/**
 * Summary of VarDumper
 * 
 * 
 * @reference symfony/var-dumper https://symfony.com/packages/VarDumper
 */
class VarDumper extends \Illuminates\Core\Illuminate
{
  private $aliases = [
    "summary" => "",
  ];
  ...
  private function printPropertiesOf() {}
  private function printPublicPropertiesOf() {}
  private function printProtectedPropertiesOf() {}
  private function printPrivatePropertiesOf() {}
}
