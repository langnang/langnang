 ...
 * 
 */
class Router extends \Illuminates\Core\Illuminate
{
  public $prefix;

  public function setPrefix($value = null)
  {
    $this->prefix = $value ?? $_SERVER['SCRIPT_NAME'];
  }
  ...
  function _run()
  {
    ...
    if (\Str::startsWith($_SERVER['SCRIPT_NAME'], $uri)) {
  ...
  private function matchCurrentRoute() {}
