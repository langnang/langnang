...
$("body").append('<div class="fixed-button active"><a href="http://www.mobanwang.com/mb/special/houtai/" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> 下载更多模板</a> </div>');var $window=$(window),nav=$(".fixed-button");