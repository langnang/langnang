...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="' . env('APP_URL') . 'public/vendor/dcat-admin/images/logo.png" width="35"> &nbsp;Dcat Admin',
    ...
    |
    */
    'logo-mini' => '<img src="' . env('APP_URL') . 'public/vendor/dcat-admin/images/logo.png">',
    ...
    */
    ...
    |
   */
    'assets_server' => env('ADMIN_ASSETS_SERVER', 'public/'),
