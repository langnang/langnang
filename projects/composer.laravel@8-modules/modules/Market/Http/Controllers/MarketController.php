...
class MarketController extends \App\Http\Controllers\Controller
{
    ...
    function view_admin_modules()
    {
        return self::admin_view('market::admin.modules');
    }
    function view_admin_modules_intro($module)
    {
        return self::admin_view('market::module.intro', ['module' => $module]);
    }
    function view_admin_modules_install($module)
    {
        return self::admin_view('market::module.install', ['module' => $module]);
    }
    function install_progress() {}
    function install_progress_of_intro() {}
    function install_progress_of_config() {}
    function install_progress_of_table() {}
    function install_progress_of_data() {}
    function install_progress_of_result() {}
}
