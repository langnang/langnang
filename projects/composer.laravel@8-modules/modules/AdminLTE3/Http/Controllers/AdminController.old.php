...
trait ViewTrait
{
    ...
    public function view_content_list()
    {
        request()->merge(['$view' => 'ssential.content-list']);
        return parent::{__FUNCTION__}();
    }
    public function view_content_item($cid = 0)
    {
    ...
    function view_dashboard_index2()
    {
        $return = [
    ...
    function view_dashboard_index3()
    {
        $return = [
    ...
    function view_module_market()
    {
        return $this->view('admin::market.index');
    }
    function view_module_market_intro($slug)
    {
        return $this->view('admin::market.module-intro', [
            'slug' => $slug,
        ]);
    }
    function view_module_market_install($slug)
    {
    ...
    function view_module_installed()
    {
        return $this->view('admin::market.index');
    }
}
...
{
    public function view_admin_basic_index()
    {
        $return = [
            'view' => 'basic.index',
            'paginator' => \Modules\Admin\Models\BasicContent::paginate(10),
        ];
        return $this->view($return);
    }
    public function view_admin_modules_index($module)
    {
        $return = [
    ...
    // 通用模块数据新增视图
    function view_admin_modules_insert_item($module, $table)
    {
        $return = [
    ...
    // 通用模块数据详情视图
    function view_admin_modules_select_item($module, $table, $id)
    {
        $return = [
            'view' => 'admin::admin.' . Module::currentConfig('layout') . '.modules.' . substr($table, 0, -1),
    ...
    // 通用模块数据查询视图
    function view_admin_modules_select_list($module, $table)
    {
    ...
    // TODO:通用模块参数配置视图
    function view_admin_system_modules_config($module = null)
    {
        if (empty($module))
    ...
    function view_admin_system_database($table = null)
    {
        $return = [
            'view' => 'system.database',
            'tables' => \DB::table('information_schema.tables')->where('table_schema', env('DB_DATABASE'))->get(),
            'columns' => empty($table) ? [] : \DB::table('information_schema.columns')->where([
    ...
    function view_system_artisan($part = null)
    {
        Artisan::call('list');
        $return = [
            '$dir' => __DIR__,
    ...
    public function view_admin_system_modules()
    {
        $return = [
    ...
    public function view_system_helpers()
    {
        $return = [
            'view' => 'system.helpers',
    ...
    public function view_system_helpers_class($class)
    {
        $return = [
            'view' => 'system.helpers',
