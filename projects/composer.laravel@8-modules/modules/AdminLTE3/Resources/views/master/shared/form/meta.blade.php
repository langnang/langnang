...
<div class="form-row">
  <div class="form-group col-md-6">
    <div class="input-group input-group-sm">
      ...
      <input type="text" class="form-control @error((isset($list) ? $index . '.' : '') . 'name'){{ '' }}is-invalid{{ '' }}@enderror" name=@isset($list) list[{{ $index }}][name] @else name @endisset placeholder="--Name--" value="{{ old(isset($list) ? "list[$index][name]" : 'name', $item['name']) }}"required>
      @error((isset($list) ? $index . '.' : '') . 'name')
  ...
  <div class="form-group col-md-3">
    <div class="input-group input-group-sm">
      ...
      <select class="form-control @error((isset($list) ? $index . '.' : '') . 'type'){{ '' }}is-invalid{{ '' }}@enderror" name=@isset($list) list[{{ $index }}][type] @else type @endisset>
  ...
  <div class="form-group col-md-3">
    <div class="input-group input-group-sm">
      ...
      <select class="form-control @error((isset($list) ? $index . '.' : '') . 'status'){{ '' }}is-invalid{{ '' }}@enderror" name=@isset($list) list[{{ $index }}][status] @else status @endisset>
