      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <ul class="nav nav-pills nav-justified mb-2" id="pills-tab" role="tablist">
            ...
            @if (View::exists($_module['slug'] . '::admin' . $_module['layout'] . '.system.modules.config'))
              <li class="nav-item" role="presentation">
        ...
        <div class="col-md-12">
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-basic" role="tabpanel" aria-labelledby="pills-basic-tab">
              @include('admin::admin.' . $_module['layout'] . '.system.modules.config-basic')
            </div>
            ...
            <div class="tab-pane fade" id="pills-make" role="tabpanel" aria-labelledby="pills-make-tab">
              @include('admin::admin.' . $_module['layout'] . '.system.modules.config-make')
            </div>
