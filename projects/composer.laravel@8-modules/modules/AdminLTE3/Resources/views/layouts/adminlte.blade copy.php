...
<body>
  ...
  <div class="wrapper">
    ...
    @section('navbar') @include($_module['slug'] . '::shared.' . $_module['layout'] . '.navbar') @show
    @section('sidebar') @include($_module['slug'] . '::shared.' . $_module['layout'] . '.sidebar') @show
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">{{ $_module['menu_actives'][0]['title'] ?? 'Dashboard' }}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <!-- /.content-wrapper -->
    @section('footer') @include($_module['slug'] . '::shared.' . $_module['layout'] . '.footer') @show
    @section('control-sidebar') @include($_module['slug'] . '::shared.' . $_module['layout'] . '.control-sidebar') @show
  </div>
  @show
  {{-- Laravel Mix - JS File --}}
  {{--
  ...
  <!-- Summernote -->
  <script src="/modules/adminlte/public/vendor/summernote/0.8.20/summernote-bs4.min.js"></script>
  <!-- overlayScrollbars -->
