...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::prefix('dashboard')->group(function () {
        \Modules\Admin\Http\Controllers\AdminDashboardController::routes();
    });
    Route::prefix('relationship')->group(function () {
        \Modules\Admin\Http\Controllers\AdminRelationshipController::routes();
    });
    Route::prefix('ssential')->group(function () {
        Route::get('/', function () {
            return redirect('admin/ssential/metas');
        });
        Route::prefix('metas')->group(function () {
            \Modules\Admin\Http\Controllers\Ssential\AdminSsentialMetaController::routes();
        });
        Route::prefix('contents')->group(function () {
            \Modules\Admin\Http\Controllers\Ssential\AdminSsentialContentController::routes();
        });

        Route::prefix('links')->group(function () {
            \Modules\Admin\Http\Controllers\Ssential\AdminSsentialLinkController::routes();
        });
        Route::prefix('files')->group(function () {
            \Modules\Admin\Http\Controllers\Ssential\AdminSsentialFileController::routes();
        });
    });
    ...
    Route::prefix('framework')->group(function () {
        Route::get('/', function () {
            return redirect('admin/ssential/migrations');
        });
        Route::prefix('migrations')->group(function () {
            \Modules\Admin\Http\Controllers\Framework\AdminFrameworkMigrationsController::routes();
        });
        Route::prefix('seeders')->group(function () {
            \Modules\Admin\Http\Controllers\Framework\AdminFrameworkSeedersController::routes();
        });
        Route::prefix('options')->group(function () {
            \Modules\Admin\Http\Controllers\Framework\AdminFrameworkOptionsController::routes();
        });
        Route::prefix('caches')->group(function () {
            \Modules\Admin\Http\Controllers\Framework\AdminFrameworkCachesController::routes();
        });
    });
    Route::prefix('system')->group(function () {
        ...
        Route::prefix('user')->group(function () {
            \Modules\Admin\Http\Controllers\System\AdminSystemUserController::routes();
        });

        Route::prefix('database')->group(function () {
            \Modules\Admin\Http\Controllers\System\AdminSystemDatabaseController::routes();
        });
    });
    Route::prefix('helper')->group(function () {
        Route::get('/', function () {
            return redirect('admin/helper/artisan');
        });
        Route::prefix('artisan')->group(function () {
            \Modules\Admin\Http\Controllers\Helper\AdminHelperArtisanController::routes();
        });
        Route::prefix('iframe')->group(function () {
            \Modules\Admin\Http\Controllers\Helper\AdminHelperIframeController::routes();
        });
        Route::prefix('chrome')->group(function () {
            \Modules\Admin\Http\Controllers\Helper\AdminHelperChromeController::routes();
        });
    });
