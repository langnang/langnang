...
<head>
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('modules/WebNav') }}/Public/onenav/css/style.min.css">
    <link rel="stylesheet" href="{{ asset('modules/WebNav') }}/Public/onenav/css/dark.min.css">
    <link rel="stylesheet" href="{{ asset('modules/WebNav') }}/Public/onenav/css/animation.min.css">
    <link rel="stylesheet" href="{{ asset('modules/WebNav') }}/Public/onenav/css/mobile.min.css">
    <link rel="stylesheet" href="{{ asset('modules/WebNav') }}/Public/onenav/css/loading.min.css">
    <link rel="stylesheet" href="https://lf26-cdn-tos.bytecdntp.com/cdn/expire-1-y/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('modules/WebNav') }}/Public/onenav/css/bootstrap.min.css">
    ...
    <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/header.min.js"></script>

    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
        
<script src="{{ asset('modules/WebNav') }}/Public/onenav/js/html5shiv.min.js"></script>

        
<script src="{{ asset('modules/WebNav') }}/Public/onenav/js/respond.min.js"></script>
    ...
    <meta property="og:image" content="{{ asset('modules/WebNav') }}/Public/onenav/images/webstack_banner_cn.png">
    ...
    <meta name="twitter:image" content="{{ asset('modules/WebNav') }}/Public/onenav/images/webstack_banner_cn.png">
...
<body class="page-body">
    ...
    <div class="main-content">
        ...
        <div id="search-list" class="hide-type-list">
          ...
          <div class="search-group group-a">
            ...
            <ul class="search-type">
              <li><input checked hidden type="radio" name="type" id="type-baidu" value="https://www.baidu.com/s?wd=" data-placeholder="百度一下，你就知道"><label for="type-baidu"><span style="color:#2100E0" class="dark-text">百度</span></label>
              </li>
              <li><input hidden type="radio" name="type" id="type-bing1" value="https://cn.bing.com/search?q=" data-placeholder="微软 Bing 搜索"><label for="type-bing1"><span style="color:#007daa">Bing</span></label>
              </li>
              <li><input hidden type="radio" name="type" id="type-google" value="https://www.google.com/search?q=" data-placeholder="谷歌搜索"><label for="type-google"><span style="color:#3B83FA">G</span><span style="color:#F3442C">o</span><span style="color:#FFC300">o</span><span
                    style="color:#4696F8">g</span><span style="color:#2CAB4E">l</span><span style="color:#F54231">e</span></label></li>
              <li><input hidden type="radio" name="type" id="type-bili1" value="https://search.bilibili.com/all?keyword=" data-placeholder="哔哩哔哩搜索"><label for="type-bili1"><span style="color:#00a1d6">BiliBili</span></label></li>
              <li><input hidden type="radio" name="type" id="type-git1" value="https://github.com/search?utf8=%E2%9C%93&q=" data-placeholder="搜索 Github 仓库"><label for="type-git1"><span style="color:#000000" class="dark-text">Github</span></label></li>
            </ul>
          </div>
          <div class="search-group group-b">
            <span class="type-text">搜索</span>
            <ul class="search-type">
              <li><input hidden type="radio" name="type" id="type-search" value="https://www.baidu.com/s?wd=" data-placeholder="百度一下，你就知道"><label for="type-search"><span style="color:#2319dc" class="dark-text">百度</span></label>
              </li>
              <li><input hidden type="radio" name="type" id="type-bing" value="https://cn.bing.com/search?q=" data-placeholder="微软 Bing 搜索"><label for="type-bing"><span style="color:#007daa">Bing</span></label>
              </li>
              <li><input hidden type="radio" name="type" id="type-google1" value="https://www.google.com/search?q=" data-placeholder="谷歌搜索"><label for="type-google1"><span style="color:#3B83FA">G</span><span style="color:#F3442C">o</span><span style="color:#FFC300">o</span><span
                    style="color:#4696F8">g</span><span style="color:#2CAB4E">l</span><span style="color:#F54231">e</span></label></li>
              ...
              <li><input hidden type="radio" name="type" id="type-bili" value="https://search.bilibili.com/all?keyword=" data-placeholder="哔哩哔哩搜索"><label for="type-bili"><span style="color:#00a1d6">BiliBili</span></label>
              </li>
              <li><input hidden type="radio" name="type" id="type-git" value="https://github.com/search?utf8=%E2%9C%93&q=" data-placeholder="搜索 Github 仓库"><label for="type-git"><span style="color:#000000" class="dark-text">Github</span></label></li>
            </ul>
          </div>
          <div class="search-group group-c">
            ...
            <ul class="search-type">
              ...
              <li><input hidden type="radio" name="type" id="type-icp" value="https://icp.chinaz.com/" data-placeholder="请输入网址 ( 不带http:// )"><label for="type-icp"><span style="color:#ffac00">备案查询</span></label></li>
              ...
              <li><input hidden type="radio" name="type" id="type-links" value="https://link.chinaz.com/" data-placeholder="请输入网址 ( 不带http:// )"><label for="type-links"><span style="color:#313439" class="dark-text">友链检测</span></label></li>
              <li><input hidden type="radio" name="type" id="type-404" value="https://stool.chinaz.com/https?url=" data-placeholder="请输入网址 ( 不带http:// )"><label for="type-404"><span style="color:#f00">HTTPS检测</span></label></li>
              <li><input hidden type="radio" name="type" id="type-ciku" value="https://seo.chinaz.com/" data-placeholder="请输入网址 ( 不带http:// )"><label for="type-ciku"><span style="color:#016DBD">SEO查询</span></label></li>
            </ul>
          </div>
          <div class="search-group group-d">
            <span class="type-text">社区</span>
            <ul class="search-type">
              <li><input hidden type="radio" name="type" id="type-zhihu" value="https://www.zhihu.com/search?type=content&q=" data-placeholder="知乎，与你分享刚编的故事"><label for="type-zhihu"><span style="color:#0084ff">知乎</span></label></li>
          ...
          <div class="search-group group-f">
            ...
            <ul class="search-type">
              ...
              <li><input hidden type="radio" name="type" id="type-liepin" value="https://www.liepin.com/zhaopin/?key=" data-placeholder="猎聘网"><label for="type-liepin"><span style="color:#303a40" class="dark-text">猎聘网</span></label></li>
            </ul>
          </div>
        </div>
        <form action="?s=" method="get" target="_blank" id="super-search-fm"><input type="text" id="search-text" placeholder="输入关键字搜索" style="outline:0" autocomplete="off"><button type="submit"><i class="fa fa-search "></i></button></form>
      ...
      <div id="bulletin_box" class="alert alert-primary" role="alert">
        <div class="d-flex text-muted">
          ...
          <a title="关闭公告" href="javascript:;" rel="external nofollow" onclick="$('#bulletin_box').slideUp('slow');" style="margin-left:auto"><i class="fa-solid fa-xmark"></i></a>
        </div>
      </div>
      <script>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://github.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://github.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/github.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://vercel.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://vercel.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/vercel.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://console.upyun.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://console.upyun.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/upyun.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>又拍云</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://console.cloud.tencent.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://console.cloud.tencent.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/cloudtencent.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>腾讯云</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.aliyun.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.aliyun.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/aliyun.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>阿里云</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.bilibili.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.bilibili.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/bilibili.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>哔哩哔哩</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.aliyundrive.com/drive', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.aliyundrive.com/drive">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/aliyundrive.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>阿里云盘</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://replit.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://replit.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/Replit.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://tool.lu/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://tool.lu/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/toollu.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>在线工具</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://notion-avatar.vercel.app/zh', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://notion-avatar.vercel.app/zh">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/notion-avatar.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://freessl.cn/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://freessl.cn/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/freessl.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://tinify.cn/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://tinify.cn/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/tinify.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://squoosh.app/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://squoosh.app/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/squoosh.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://onlineconvertfree.com/zh/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://onlineconvertfree.com/zh/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/onlineconvertfree.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.dute.org/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.dute.org/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/dute.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>独特工具箱</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.niceso.fun/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.niceso.fun/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/niceso.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>奈斯搜索</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://ps.gaoding.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://ps.gaoding.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/gaoding.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>在线 PS</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://xmsoushu.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://xmsoushu.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/xmsoushu.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>熊猫搜书</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://caniuse.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://caniuse.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/CanIuse.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://fontawesome.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://fontawesome.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/fontawesome.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.iconfont.cn/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.iconfont.cn/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/iconfont.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://remixicon.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://remixicon.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/remixicon.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://neumorphism.io/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://neumorphism.io/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/neumorphism.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://lingdaima.com/shadow/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://lingdaima.com/shadow/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/smoothshadow.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://lingdaima.com/jianbianse/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://lingdaima.com/jianbianse/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/cssgradient.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.tablesgenerator.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.tablesgenerator.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/tablesgenerator.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://colorhunt.co/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://colorhunt.co/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/colorhunt.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://unsplash.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://unsplash.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/unsplash.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.w3school.com.cn/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.w3school.com.cn/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/w3school.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.runoob.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.runoob.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/runoob.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>菜鸟教程</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://developer.mozilla.org/zh-CN/docs/Web', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://developer.mozilla.org/zh-CN/docs/Web">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/MDN.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.csdn.net/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.csdn.net/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/csdn.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>CSDN</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.icourse163.org/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.icourse163.org/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/mooc.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://study.163.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://study.163.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/study163.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>网易云课堂</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.imooc.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.imooc.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/imooc.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>慕课网</strong>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://angular.cn/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://angular.cn/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/angular.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://react.docschina.org/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://react.docschina.org/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/react.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>React</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://staging-cn.vuejs.org/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://staging-cn.vuejs.org/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/vue.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>Vue</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.naiveui.com/zh-CN/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.naiveui.com/zh-CN/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/NaiveUI.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://layui.github.io/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://layui.github.io/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/layui.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>Layui</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://element-plus.gitee.io/zh-CN/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://element-plus.gitee.io/zh-CN/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/element.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.mdui.org/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.mdui.org/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/mdui.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>MDUI</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://getbootstrap.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://getbootstrap.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/bootstrap.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://amazeui.shopxo.net/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://amazeui.shopxo.net/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/amaze.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>Amaze</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://youzan.github.io/vant/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://youzan.github.io/vant/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/vant.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
                  <strong>Vant</strong>
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.iviewui.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.iviewui.com/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/iviewui.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
        ...
        <div class="col-sm-3">
          <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.tailwindcss.cn/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.tailwindcss.cn/">
            <div class="xe-comment-entry">
              <a class="xe-user-img">
                <img data-src="{{ asset('modules/WebNav') }}/Public/onenav/images/logos/tailwindcss.png" class="lozad img-circle" width="40" src="{{ asset('modules/WebNav') }}/Public/onenav/images/loading.svg">
              </a>
              <div class="xe-comment">
                <a href="#" class="xe-user-name overflowClip_1">
      ...
      <div class="wapnone fk_service">
        <ul>
          <li class="fk_service_box fk_service_ax" onclick="switchNightMode()">
            <div class="fk_service_ax_cont" id="fk-span"> <span class="fk_service_triangle" id="fk-span-right"></span><span id="fk_service_text">切换夜间模式</span></div>
          </li>
          <li class="fk_service_box fk_service_jk">
            <a data-toggle="sidebar">
              <div class="fk_service_jk_cont" id="fk-span"> <span class="fk_service_triangle" id="fk-span-right"></span>切换侧边栏</div>
            </a>
          </li>
          <li class="fk_service_box fk_service_dh" onclick="window.location=('/submit/')">
            <div class="fk_service_dh_cont" id="fk-span"> <span class="fk_service_triangle" id="fk-span-right"></span>提交网站收录</div>
          </li>
          <a rel="go-top">
            <li class="fk_service_box fk_service_upward" id="topup" style="display: none;">
              <div class="fk_service_upward_cont" id="fk-span"> <span class="fk_service_triangle" id="fk-span-right"></span> <span>返回顶部</span>
              </div>
            </li>
          </a>
        </ul>
      ...
      <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/footer.min.js"></script>
      ...
      <footer class="main-footer sticky footer-type-1">
        <div class="footer-inner">
          ...
          <p>
            ...
            &copy; 2020 - 2022
            <a href="https://www.imsyy.top" target="_blank"><strong>無名</strong></a> | Design by <a href="http://viggoz.com" target="_blank"><strong>Viggo</strong></a> | Power by <a href="https://hexo.io/" target="_blank"><strong>Hexo</strong></a> & <a
              href="https://github.com/HCLonely/hexo-theme-webstack/" target="_blank"><strong>hexo-theme-webstack</strong></a>
          </p>
          <!-- <div class="go-up">
      <a href="#" rel="go-top">
  ...
  <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/bootstrap.min.js"></script>
  <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/TweenLite.min.js"></script>
  <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/resizeable.min.js"></script>
  <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/joinable.js"></script>
  <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/xenon-api.min.js"></script>
  <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/xenon-toggles.min.js"></script>
  <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/xenon-custom.min.js"></script>



  <script src="{{ asset('modules/WebNav') }}/Public/onenav/js/lozad.min.js"></script>
