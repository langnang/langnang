...
class CreateSpiderCollectUrlsTable extends \App\Illuminate\Database\Migrations\Migration
{
    protected $prefix = "";
    protected $tableName = "_spider_collect_urls";
    ...
    public function up()
    {
        ...
        Schema::create($tableName, function (Blueprint $table) {
            ...
            $table->integer("user_id")->nullable()->default(0)->comment("用户编号");
            $table->integer("spider_id")->nullable()->default(0)->comment("爬虫编号");
