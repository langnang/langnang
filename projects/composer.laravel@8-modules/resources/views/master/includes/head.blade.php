...
<link rel="stylesheet" href="{{ asset('public/plugins/normalize.css/8.0.1/normalize.css') }}">
{{-- <link rel="stylesheet" href="https://unpkg.com/normalize.css@8.0.1/normalize.css"> --}}
<link rel="stylesheet" href="{{ asset('public/plugins/bootstrap/4.6.2/css/bootstrap.min.css') }}">
{{-- <link rel="stylesheet" href="https://unpkg.com/bootstrap@4.6.2/dist/css/bootstrap.css"> --}}
<link rel="stylesheet" href="{{ asset('public/plugins/bootstrap-icons/1.10.5/bootstrap-icons.min.css') }}">
