...
<head>
  ...
  <x-style rel="stylesheet" path="public/plugins/normalize.css/8.0.1/normalize.css"></x-style>
  {{-- <link rel="stylesheet" href="https://unpkg.com/normalize.css@8.0.1/normalize.css"> --}}
  <x-style rel="stylesheet" path="public/plugins/bootstrap/4.6.2/css/bootstrap.min.css"></x-style>
  {{-- <link rel="stylesheet" href="https://unpkg.com/bootstrap@4.6.2/dist/css/bootstrap.css"> --}}
  <x-style rel="stylesheet" path="public/plugins/bootstrap-icons/1.10.5/bootstrap-icons.min.css"></x-style>
  {{-- <link rel="stylesheet" href="https://unpkg.com/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css"> --}}
  <!-- Font Awesome -->
  <x-style :path="'public/plugins/@fortawesome/fontawesome-free/6.5.1/css/all.min.css'"></x-style>
  {{-- AdminLTE --}}
  <x-style rel="stylesheet" path="public/plugins/admin-lte/3.2.0/css/adminlte.min.css"></x-style>
  <!-- overlayScrollbars -->
  <x-style rel="stylesheet" path="public/plugins/overlayScrollbars/1.13.0/css/OverlayScrollbars.min.css"></x-style>
  {{-- @section('head')
  ...
  <x-style rel="stylesheet" path="public/master/css/style.css"></x-style>



  @isset($_module)
    {{-- <link rel="stylesheet" href="{{ asset('./modules/' . $_module['name'] . '/Public/' . \Arr::get($_module, 'view.framework') . '/style.css') }}"> --}}
  @endisset
...
<body class="bg-gray-100 dark:bg-gray-900">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: unset;">
    <!-- Brand Logo -->
    ...
    <div class="wrapper-content" style="min-height: calc(100vh - 129px)">
      @yield('content')
    </div>
    ...
    @show @endif
                                                                                                    ...
                                                                                                    <div class="fixed-bottom"
                                                                                                      style="right: .75rem;bottom: .75rem;left: unset;">
                                                                                                      <ul class="list-group">
  ...
  <li class="list-group-item h2 mb-0 p-2" data-toggle="popover" data-html="true" data-content='<ul class="list-style text-left mb-0 pl-3">
  ...
  {{-- <script crossorigin="anonymous" src="{{ asset('public/plugins/axios/0.21.4/axios.min.js') }}"></script> --}}
  {{-- <script crossorigin="anonymous" src="https://unpkg.com/axios"></script> --}}
  <script crossorigin="anonymous" src="{{ asset('public/plugins/jquery/3.6.4/jquery.slim.min.js') }}"></script>
  {{-- <script crossorigin="anonymous" src="https://unpkg.com/jquery"></script> --}}
  <script crossorigin="anonymous" src="{{ asset('public/plugins/popper.js/1.16.1/popper.min.js') }}"></script>
  {{-- <script crossorigin="anonymous" src="https://unpkg.com/popper.js"></script> --}}
  <script crossorigin="anonymous" src="{{ asset('public/plugins/bootstrap/4.6.2/js/bootstrap.bundle.min.js') }}"></script>
  ...
  {{-- AdminLTE --}}
  <x-script path="public/plugins/admin-lte/3.2.0/js/adminlte.min.js"></x-script>

  <x-script path="public/master/js/adminlte.demo.js"></x-script>
  {{-- public/master/js/adminlte.demo.js --}}
  @stack('pluginScripts')
  ...
  @isset($_module)
    {{-- <script crossorigin="anonymous" src="{{ asset('./modules/' . $_module['name'] . '/Public/' . \Arr::get($_module, 'view.framework') . '/script.js') }}"></script> --}}
  @endisset
  </body>
