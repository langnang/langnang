...
- [symmetric_difference_update()](http://docs.python.org/library/stdtypes.html#set.symmetric_difference_update 'Update the set, keeping only elements found in either set, but not in both.')
