<template>
  <view class="container">
    <view class="uni-flex uni-column game-body" style="height: calc(100vh - 84px);">
      <view class="flex-item heading">
      ...
      <view class="uni-flex flex-item" style="flex: 1 1 0%; justify-content: center; align-items: center;">
