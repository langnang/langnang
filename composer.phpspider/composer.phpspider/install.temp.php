                    ...
                    <?php elseif (isset($_GET['start'])) : ?>
                        ...
                        <?php else : ?>
                            ...
                            try {
                                ...
                                /** 初始分类 */
                                $installDb->query($installDb->insert('table.metas')->rows(array(
                                ...
                                /** 初始内容 */
                                $installDb->query($installDb->insert('table.contents')->rows(array(
                                ...
                                /** 初始评论 */
                                $installDb->query($installDb->insert('table.comments')->rows(array(
                                ...
                                $installDb->query($installDb->insert('table.users')->rows(array(
                                    'name' => $config['userName'], 'password' => $hasher->HashPassword($password), 'mail' => $config['userMail'],
