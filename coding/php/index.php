...
<head>
  ...
  <title>PHP v<? echo phpversion() ?></title>
...
<body>
  <div id="app" class="container-fluid">
    <h1 class="text-center">PHP v<? echo phpversion() ?></h1>
    <h2>Classes</h2>
    <h2>Helpers</h2>
    <h2>Practices</h2>
    <ul>
    ...
    <h2>Units</h2>
    <ul>
      <li><a href="./units/phpinfo.php">PhpInfo</a></li>
      <li><a href="./units/progress.php">Progress</a></li>
    </ul>
    <h2>Utils</h2>
    <ul>
